import 'package:fltr_pdascan/Components/select_warehouse.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  _startScanner(int type) {
    Get.toNamed('scanner', arguments: type);
  }
          ...
          child: Column(
            ...
            children: [
              ...
              RaisedButton(
                ...
                onPressed:
                    warehouseId.isNotEmpty ? () => _startScanner(0) : null,
                padding:
              ...
              RaisedButton(
                ...
                color: Colors.blue[300],
                onPressed:
                    warehouseId.isNotEmpty ? () => _startScanner(1) : null,
                padding:
                    EdgeInsets.only(left: 32, right: 32, top: 4, bottom: 4),
                child: Text(
                  "تسليم مبيعات",
              ...
              RaisedButton(
                ...
                color: Colors.blue[300],
                onPressed:
                    warehouseId.isNotEmpty ? () => _startScanner(2) : null,
                padding:
                    EdgeInsets.only(left: 32, right: 32, top: 4, bottom: 4),
                child: Text(
                  " الجرد",
              ...
              RaisedButton(
                ...
                color: Colors.blue[300],
                onPressed:
                    warehouseId.isNotEmpty ? () => _startScanner(3) : null,
                padding:
                    EdgeInsets.only(left: 32, right: 32, top: 4, bottom: 4),
                child: Text(
                  "استلام بضائع",
