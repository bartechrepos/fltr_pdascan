import 'package:fltr_pdascan/Components/username_input.dart';
import 'package:fltr_pdascan/Components/PasswordText.dart';
import 'package:fltr_pdascan/Components/SelectBranch.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _logIn(String branchId, String username, String password) async {
    ...
    await http.post("${Constants.IMIS_URL}/Scanner/login", body: {
      "username": username,
      "password": password,
      "branch_id": branchId
    }).then((response) {
